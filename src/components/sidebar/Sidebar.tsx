...
const Sidebar: React.FC<SidebarProps> = (props) => {
  ...
  return (
    <div className="w-64 h-screen sticky top-0 p-4 bg-gray-100 dark:bg-black flex flex-col justify-between shadow-lg transition-transform duration-300 ease-in-out lg:transform-none lg:translate-x-0">  
